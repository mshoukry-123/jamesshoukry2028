export interface VideoClip {
  ...
  height: number;
  vertical: boolean;
  /** True when the source had only a music bed, so the clip ships without audio. */
  silent?: boolean;
}
...
export const playerData: PlayerProfile = {
  ...
  clips: [
  {
    ...
    slug: "hit-game-1",
    n: 1,
    title: "In-Game At-Bat - Base Hit, Runs It Out",
    category: "game",
    categoryLabel: "IN GAME",
    duration: "0:05",
    scoutingNote: "Live at-bat at Joe Lee Griffin Field, Samford. Barrel through the ball and he runs every step of it out of the box. Natural audio.",
    ...
    slug: "hit-img-1",
    n: 3,
    title: "In-Game At-Bat - IMG Academy",
    category: "game",
    categoryLabel: "IN GAME",
    duration: "0:04",
    scoutingNote: "Behind the plate at IMG Academy. Setup and trigger from the catcher's angle.",
    videoSrc: "/videos/hit_img_1.mp4",
    thumbnailSrc: "/thumbnails/hit_img_1.jpg",
    width: 1920, height: 1080, vertical: false,
  },
    {
    id: "game_ab_5",
    ...
    slug: "ec-hit-1",
    n: 6,
    title: "Showcase BP - Load and Launch, Side View",
    category: "showcase",
    categoryLabel: "SHOWCASE BP",
    duration: "0:03",
    scoutingNote: "Perfect Game WWBA Workout Showcase, East Cobb Complex, June 24 2025. Hands work inside and the barrel stays on plane.",
    videoSrc: "/videos/ec_hit_1.mp4",
    thumbnailSrc: "/thumbnails/ec_hit_1.jpg",
    width: 1920, height: 1080, vertical: false,
    silent: true,
  },
    {
    ...
    slug: "ec-hit-2",
    n: 7,
    title: "Showcase BP - Same Move, Next Pitch",
    category: "showcase",
    categoryLabel: "SHOWCASE BP",
    duration: "0:03",
    scoutingNote: "Second rep of the East Cobb round from the same angle. Stride length and finish do not change.",
    videoSrc: "/videos/ec_hit_2.mp4",
    thumbnailSrc: "/thumbnails/ec_hit_2.jpg",
    width: 1920, height: 1080, vertical: false,
    silent: true,
  },
    {
    ...
    slug: "bp-night-1",
    n: 8,
    title: "Showcase BP - Under Lights, Rep One",
    category: "showcase",
    categoryLabel: "SHOWCASE BP",
    duration: "0:03",
    scoutingNote: "Night showcase round. Side view of the load, stride and finish, with the bat audible at contact.",
    videoSrc: "/videos/bp_night_1.mp4",
    thumbnailSrc: "/thumbnails/bp_night_1.jpg",
    width: 1920, height: 1080, vertical: false,
  },
    {
    id: "bp_night_2",
    ...
    categoryLabel: "SHOWCASE BP",
    duration: "0:03",
    scoutingNote: "Front side holds and the barrel stays on plane. Balanced finish with no leak toward the pull side.",
    videoSrc: "/videos/bp_night_2.mp4",
    thumbnailSrc: "/thumbnails/bp_night_2.jpg",
    width: 1920, height: 1080, vertical: false,
  },
    {
    id: "bp_night_3",
    slug: "bp-night-3",
    n: 10,
    title: "Showcase BP - Repeatable Under Fatigue",
    category: "showcase",
    categoryLabel: "SHOWCASE BP",
    duration: "0:03",
    scoutingNote: "Third rep of the same round. Timing and finish do not change late in the set.",
    videoSrc: "/videos/bp_night_3.mp4",
    thumbnailSrc: "/thumbnails/bp_night_3.jpg",
    width: 1920, height: 1080, vertical: false,
  },
    {
    id: "ec_hit_3",
    slug: "ec-hit-3",
    n: 11,
    title: "Showcase BP - Head-On View",
    category: "showcase",
    categoryLabel: "SHOWCASE BP",
    duration: "0:03",
    scoutingNote: "Front view from behind the L-screen at East Cobb. Stays behind the ball with no pull-off.",
    videoSrc: "/videos/ec_hit_3.mp4",
    thumbnailSrc: "/thumbnails/ec_hit_3.jpg",
    width: 1920, height: 1080, vertical: false,
    silent: true,
  },
    {
    ...
    slug: "ec-def-3",
    n: 16,
    title: "3B Defense - Full Rep, Start to Finish",
    category: "defense",
    categoryLabel: "3B DEFENSE",
    duration: "0:06",
    scoutingNote: "East Cobb infield workout. Approach, field, crow-hop and throw, with the arm action complete all the way through.",
    videoSrc: "/videos/ec_def_3.mp4",
    thumbnailSrc: "/thumbnails/ec_def_3.jpg",
    width: 1920, height: 1080, vertical: false,
    silent: true,
  },
    {
    ...
    slug: "ec-def-1",
    n: 17,
    title: "3B Defense - Field and Throw, Glove Side",
    category: "defense",
    categoryLabel: "3B DEFENSE",
    duration: "0:05",
    scoutingNote: "Infield workout at East Cobb. Works through the ball into the throw rather than catching it flat-footed.",
    videoSrc: "/videos/ec_def_1.mp4",
    thumbnailSrc: "/thumbnails/ec_def_1.jpg",
    width: 1920, height: 1080, vertical: false,
    silent: true,
  },
    {
    ...
    slug: "ec-def-2",
    n: 18,
    title: "3B Defense - Transfer and Fire",
    category: "defense",
    categoryLabel: "3B DEFENSE",
    duration: "0:05",
    scoutingNote: "Clean exchange with quick feet underneath him. Throw carries across the diamond.",
    videoSrc: "/videos/ec_def_2.mp4",
    thumbnailSrc: "/thumbnails/ec_def_2.jpg",
    width: 1920, height: 1080, vertical: false,
    silent: true,
  },
    {
